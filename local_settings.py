...
TWITTER_API_VERSION = 'v2' # All new bots use API v2. Use "v1.1" for older API keys.
MY_BEARER_TOKEN = environ.get('TWITTER_BEARER_TOKEN')
MY_CONSUMER_KEY = environ.get('MY_CONSUMER_KEY')#Your Twitter API Consumer Key set in Heroku config
MY_CONSUMER_SECRET = environ.get('MY_CONSUMER_SECRET')#Your Consumer Secret Key set in Heroku config
MY_ACCESS_TOKEN_KEY = environ.get('MY_ACCESS_TOKEN')#Your Twitter API Access Token Key set in Heroku config
MY_ACCESS_TOKEN_SECRET = environ.get('MY_ACCESS_TOKEN_SECRET')#Your Access Token Secret set in Heroku config
...
TWITTER_SOURCE_ACCOUNTS = ["sodasteal"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
